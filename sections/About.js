...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="flex justify-center items-center relative px-5 md:p-0"
    >
      <GradientSphere
              ...
              <div className="rounded-2xl p-7 w-full h-full bg-[url(/images/b1.svg)] bg-cover border border-white/20 flex flex-col justify-between">
                <div className="sm:max-w-108 max-w-10/12 hover:translate-x-5 transition-all duration-300">
                  ...
                  <p className="animated-text md:text-2xl aeonik-medium">
                    ...
                    expertise lies in <em>MERN Stack</em> and <em>Next.js</em>.
                    I&apos;m always learning and exploring new tools and
                    technologies.
                  </p>
                </div>
                {/* Icons */}
                <div className="flex items-center gap-6 md:gap-8">
                  {footerIconsList.map((icon, index) => (
                    <div key={index} className="relative group">
                      ...
                      {/* Tooltip */}
                      <span className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap px-3 py-1 text-xs rounded-md bg-white/10 backdrop-blur-sm text-white opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                        {icon.name}
                      </span>
                    </div>
                  ))}
                  ...
                  <BackgroundGradientAnimation>
                    ...
                    <div className="flex justify-center p-7">
                      <Link
                        ...
                        className="bg-black-300 gradient-border md:px-10 px-6 p-4 text-center md:text-lg marquee-item flex items-center justify-center gap-2 z-100 text-white/80"
                      >
