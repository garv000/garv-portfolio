...
const Hero = () => {
    return (
        <section id='home' className='w-screen overflow-hidden text-white-50 h-dvh relative px-5 md:p-0'>
            ...
            <div className='w-full h-full flex items-center justify-center'>
                <div className='container relative w-full h-full'>
                    <div className='md:mt-40 mt-20'>
                        ...
                        <h1 className='aeonik-bold md:text-9xl text-5xl'>CREATIVE</h1>
                    </div>
                    ...
                    <div className='absolute w-full z-30 bottom-20 right-0'>
                        <div className='flex justify-between items-end'>
                            ...
                            <div className='flex flex-col items-end'>
                                ...
                                <h1 className='aeonik-bold md:text-9xl text-5xl'>DEVELOPER</h1>
                            </div>
                        </div>
                    </div>
                </div>
