      ...
      <div className="w-full h-full flex items-center justify-center">
        <div className="container relative w-full h-full">
          <div className="mt-36">
            ...
            <h1 className="font-bold md:text-9xl text-5xl">GARV</h1>
            <h1 className="font-bold md:text-9xl text-5xl"> SINGHAL</h1>
          </div>
          ...
          <div className="absolute w-full z-30 bottom-20 md:bottom-10 right-0">
            <div className="flex justify-between items-end">
              ...
              <div className="flex flex-col items-end">
                ...
                <h1 className="font-bold md:text-8xl text-5xl">DEVELOPER</h1>
              </div>
            </div>
          </div>
        </div>
